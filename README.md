...
### 👩‍💻 About Me
A passionate **Frontend (Mobile) Developer** specializing in building cross-platform applications using **Flutter**. I focus on creating smooth user interfaces and integrating robust backend services.

- 🔭 I’m currently working on enhancing my **State Management** skills.
- ⚡ Fun fact: I love turning UI designs from Figma into high-performance code.
